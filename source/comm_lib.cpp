/*
	This code defines the functions needed to process bounding boxes of the detected faces.

	Imported from https://github.com/njvisionpower/mxnet-insightface-cpp/blob/master/src/comm_lib.cpp
*/
