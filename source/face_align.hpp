/*
	This code defines the functions used to align the detected faces.

	Imported from https://github.com/njvisionpower/mxnet-insightface-cpp/blob/master/src/face_align.hpp
*/
