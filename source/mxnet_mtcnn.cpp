/*
	This code is an implementation of MTCNN face detector.

	Imported from https://github.com/njvisionpower/mxnet-insightface-cpp/blob/master/src/mxnet_mtcnn.cpp
*/
